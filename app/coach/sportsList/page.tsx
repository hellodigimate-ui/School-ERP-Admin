...
export default function SportsList() {
  ...
  const handleCreate = async () => {
    try {
      ...
      const res = await axiosInstance.post("/api/v1/sports", {
        ...form,
        ...(branchId ? { branchId } : {}),
      });
    ...
    <Layout>
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 p-4 rounded-xl border">
            ...
            <DialogContent className="max-w-lg">
                ...
                {/* Branch is automatically set from profile branchId in localStorage */}
                <p className="text-sm text-gray-600">Branch is auto-selected (localStorage)</p>
