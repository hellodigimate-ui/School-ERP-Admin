    ...
    <Layout>
        ...
        <div className="flex flex-wrap justify-between items-center gap-4">
            ...
            <DialogContent className="space-y-6 w-full max-w-md max-h-[80vh] overflow-y-auto p-6 bg-gradient-to-br from-white to-green-50 rounded-2xl shadow-xl">
                ...
                {/* Branch is auto-selected from profile */}
                <div className="p-3 rounded-xl border border-green-100 bg-green-50">
                  <p className="text-sm text-green-700">Branch is automatically loaded from profile branchId.</p>
                </div>
        ...
        <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
            ...
            {/* Branch is auto-selected from profile */}
            <p className="text-sm text-gray-600">Branch is auto-selected from localStorage branchId.</p>
