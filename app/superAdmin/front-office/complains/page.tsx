...
const Page = () => {
  ...
  const fetchBranches = async () => {
    try {
      ...
      const { data } = await axiosInstance.get("/api/v1/branches?perPage=100");
  ...
  useEffect(() => {
    fetchComplaints();
    fetchStats();
  }, [page, filters.title, filters.status, filters.type, filters.branchId]);
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axiosInstance.put(`${API_URl}/${selectedComplaint.id}`, {
        ...editData,
  ...
  return (
    <AdminLayout>
      <div className="space-y-6 max-w-[1400px]">
        ...
        >
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button
                className="gap-2 px-6 h-11 rounded-xl 
                                bg-gradient-to-r from-primary to-purple-500
            ...
            <DialogContent
              className="sm:max-w-2xl rounded-3xl p-8 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
          {[
            ...
            >
              ...
              <div
                className={`absolute -top-10 -right-10 w-36 h-36 rounded-full ${s.gradient} opacity-10 blur-3xl`}
              />
              ...
              <CardContent className="relative p-6 flex items-center gap-5">
                ...
                <div>
                  ...
                  <p
                    className={`text-3xl font-extrabold font-display ${s.text}`}
                  >
                    {s.value}
                  </p>
                </div>
        ...
        <Card
          className="relative border-0 rounded-3xl bg-card/50 backdrop-blur-xl
                        shadow-md hover:shadow-2xl
        ...
        >
          ...
          <CardContent className="relative p-6">
            <div className="flex flex-col md:flex-row gap-4 md:items-end">
              ...
              >
                <SelectTrigger
                  className="w-[140px] h-11 rounded-xl bg-muted/40 border-muted
                                          focus:ring-2 focus:ring-primary/40 transition-all"
                >
              ...
              <div className="min-w-[220px]">
                ...
                >
                  <SelectTrigger className="w-full h-11 rounded-xl bg-muted/40 border-muted focus:ring-2 focus:ring-primary/40 transition-all">
        ...
        <Card
          className="relative border-0 shadow-lg rounded-3xl overflow-hidden
                        bg-card/50 backdrop-blur-xl
              ...
              <TableBody>
                {complaints.map((c) => (
                  ...
                  >
                    ...
                    <TableCell className="text-muted-foreground">
                      {branches.find((branch) => branch.id === c.branchId)
                        ?.name ||
                        c.branchId ||
                        "-"}
                    </TableCell>
                    ...
                    <TableCell className="text-right">
                      <div className="flex gap-1 justify-end">
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-8 w-8 hover:bg-primary/10 transition"
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-8 w-8 hover:bg-blue-100 hover:text-blue-600 transition"
                          onClick={() => {
