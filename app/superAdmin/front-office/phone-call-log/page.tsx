...
const Page = () => {
  ...
  }, [page, search, filterType, branchFilter, selectedBranchId]);
        ...
        <div className="space-y-6">
              ...
              <DialogContent className="max-w-lg rounded-2xl bg-card/90 backdrop-blur-xl shadow-2xl border border-border/50 dark:bg-gray-900">
                ...
                <div className="grid grid-cols-2 gap-5 pt-6 dark:bg-gray-900">
                  <div className="space-y-2 dark:bg-gray-900">
                    ...
                    <Input
                      className="rounded-xl bg-background/50 focus:ring-2 focus:ring-primary/40 dark:bg-gray-900   "
                      name="callerName"
                      value={formData.callerName}
                      onChange={handleInputChange}
                      placeholder="Caller/Receiver name"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      className="rounded-xl bg-background/50 focus:ring-2 focus:ring-primary/40"
                      name="phoneNumber"
                  ...
                  <div className="space-y-2">
                    <Label className="text-foreground/70">Branch</Label>
                    <Select
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      className="rounded-xl bg-gray-50 focus:ring-2 focus:ring-indigo-400"
                      name="purpose"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
            {[
              ...
              <Card
                key={s.label}
                className="border-0 shadow-lg rounded-2xl bg-white/80 backdrop-blur-md hover:shadow-xl transition dark:bg-gray-900"
              >
            ...
            <CardContent className="p-6">
              <div className="flex gap-4 items-end">
                ...
                <div className="min-w-[180px]">
                  ...
                  >
                    <SelectTrigger className="w-full rounded-xl bg-gray-50 focus:ring-2 focus:ring-indigo-400 dark:bg-gray-900">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-gray-900">
                    ...
                    <TableHead className="font-semibold text-right text-gray-700  dark:text-gray-400">
                      Actions
                    </TableHead>
                  </TableRow>
                </TableHeader>
                ...
                <TableBody>
                  {calls.map((c) => (
                    <TableRow
                      key={c.id}
                      className="hover:bg-indigo-50/50 transition dark:text-gray-400"
                    >
