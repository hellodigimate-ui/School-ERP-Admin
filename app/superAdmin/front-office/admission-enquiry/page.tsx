...
const Page = () => {
  ...
  const handleDownload = async () => {
    try {
      const response = await axiosInstance.get(
        "/api/v1/admission-enquiries/report",
        {
  ...
  useEffect(() => {
    fetchEnquiries();
  }, [searchTerm, pageNumber, branchFilter, selectedBranchId]);
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="h-11 rounded-xl border-primary/20 bg-muted/40 focus-visible:ring-2 focus-visible:ring-primary/40">
            ...
            <div className="flex flex-wrap gap-4 items-end">
              ...
              <div className="min-w-[220px]">
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    if (!isGlobalBranchSelected) setBranchFilter(value);
                  }}
                  disabled={isGlobalBranchSelected}
                >
                  <SelectTrigger className="mt-1 rounded-xl border-border bg-background">
                ...
                {enquiries.map((e) => (
                  ...
                  >
                    ...
                    <TableCell className="text-muted-foreground">
                      {branches.find((branch) => branch.id === e.branchId)
                        ?.name ||
                        e.branchId ||
                        "-"}
                    </TableCell>
                    ...
                    <TableCell className="text-right">
                              ...
                              <div className="bg-secondary p-4 rounded-xl shadow-sm grid grid-cols-2 gap-3 text-sm">
                                ...
                                <p>
                                  ...
                                  <span className="text-muted-foreground">
                                    {branches.find(
                                      (branch) =>
                                        branch.id === selectedEnquiry.branchId,
                                    )?.name ||
                                      selectedEnquiry.branchId ||
                                      "-"}
                                  </span>
                                </p>
                                <p>
                      ...
                      <Dialog open={editOpen} onOpenChange={setEditOpen}>
                        <DialogContent
                          className="max-w-2xl rounded-3xl p-8 
                                        bg-background/80 backdrop-blur-xl 
                                        border shadow-2xl"
                        >
                          {/* Header */}
