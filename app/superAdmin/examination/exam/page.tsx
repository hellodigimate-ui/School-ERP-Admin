    ...
    <AdminLayout>
      <div className="space-y-6 p-6">
            ...
            <DialogContent className="max-w-lg">
              ...
              <div className="space-y-4 mt-4">
                <div>
                  <Label>Branch</Label>
                  <Select
                    value={newExam.branchId || branchFilter || "all"}
                    onValueChange={(value) => {
                      setNewExam({ ...newExam, branchId: value, classId: "" });
                      if (!isGlobalBranchSelected) {
                        setLocalBranch(value === "all" ? "all" : value);
                      }
                    }}
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <Select
            value={
              isGlobalBranchSelected ? (selectedBranchId ?? "all") : localBranch
            }
            onValueChange={(value) => {
              setLocalBranch(value === "ALL_BRANCHES" ? "all" : value);
              setSelectedClass("");
            }}
            disabled={isGlobalBranchSelected}
          >
