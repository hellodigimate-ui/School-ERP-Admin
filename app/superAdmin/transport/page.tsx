...
const Page: React.FC = () => {
  ...
  const handleAdd = async () => {
    try {
      const branchId = branchFilter ?? form.branchId;
  ...
  const handleEditClick = (route: any) => {
    ...
    setForm({
      ...
      branchId: route?.branchId || branchFilter || "",
    });
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axiosInstance.put(`${API_URL}/routes/${selectedRoute.id}`, {
        ...
        vehicleId: form.bus,
        distance: Number(form.distance),
        branchId: branchFilter ?? form.branchId,
      });
  ...
  const handleVehicleAdd = async () => {
    try {
      const branchId = branchFilter ?? vehicleForm.branchId;
  ...
  const handleVehicleEditClick = (v: any) => {
    ...
    setVehicleForm({
      ...
      driverId: v?.driverId || "",
      branchId: v?.branchId || branchFilter || "",
    });
  ...
  const handleVehicleUpdate = async () => {
    try {
      ...
      await axiosInstance.put(`${API_URL}/vehicles/${selectedVehicle.id}`, {
        ...
        status: vehicleForm.status,
        driverId: vehicleForm.driverId || null,
        branchId: branchFilter ?? vehicleForm.branchId,
      });
  ...
  const handlePickupAdd = async () => {
    try {
      const branchId = branchFilter ?? pickupForm.branchId;
  ...
  const handlePickupEditClick = (p: any) => {
    ...
    setPickupForm({
      ...
      branchId: p?.branchId || branchFilter || "",
    });
  ...
  const handlePickupUpdate = async () => {
    try {
      ...
      await axiosInstance.put(`${API_URL}/pickup-points/${selectedPickup.id}`, {
        ...
        routeId: pickupForm.route,
        vehicleId: pickupForm.vehicleId || null,
        branchId: branchFilter ?? pickupForm.branchId,
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 rounded-2xl border border-muted/30 bg-muted/10 p-4 shadow-sm">
          <p className="text-sm text-muted-foreground">
            {isGlobalBranchSelected
              ...
              : "Use the branch filter to scope transport data locally."}
          </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                    ...
                    <div className="flex flex-col gap-1 md:col-span-2">
                      ...
                      <div className="relative group">
                        <select
                          value={vehicleForm.branchId || branchFilter || ""}
                          onChange={(e) =>
                            setVehicleForm({
                              ...vehicleForm,
                  ...
                  {routes
                    ...
                    .map((route) => (
                      ...
                      >
                        ...
                        <TableCell>{route.branch?.name || "-"}</TableCell>
                ...
                <DialogContent className="max-w-3xl p-6 rounded-2xl bg-gradient-to-br from-white to-blue-50 shadow-xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="relative">
                        <select
                          value={form.branchId || branchFilter || ""}
                          onChange={(e) =>
                ...
                <DialogContent className="max-w-3xl p-6 rounded-2xl bg-gradient-to-br from-white to-purple-50 shadow-xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="relative">
                        <select
                          value={pickupForm.branchId || branchFilter || ""}
                          onChange={(e) =>
                            setPickupForm({
                              ...pickupForm,
                              branchId: e.target.value,
