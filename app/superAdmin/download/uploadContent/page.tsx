...
const Page = () => {
  ...
  useEffect(() => {
    fetchContents();
  }, [search, branchFilter, selectedBranchId]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {statsData.map((s) => (
            ...
            >
              {/* Glow Effect */}
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-10 transition bg-gradient-to-br ${s.gradient}`}
              />
            ...
            <CardContent className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div
                    className="border-2 border-dashed border-purple-300 rounded-xl p-4 text-center hover:bg-purple-50 transition cursor-pointer"
                    onClick={() =>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="relative w-full md:w-64">
                ...
                <select
                  ...
                  className="w-full h-10 rounded-md border border-input bg-background pl-3 pr-3 text-sm focus:ring-2 focus:ring-purple-400"
                >
