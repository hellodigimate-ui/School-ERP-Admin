    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <Tabs defaultValue={defaultTab} className="space-y-6">
          ...
          <TabsList
            className="
              flex flex-wrap gap-2 p-1.5 rounded-2xl
              bg-gradient-to-r 
          ...
          >
            ...
            <TabsTrigger
              ...
              "
            >
              <IndianRupeeIcon size={14} className="transition-transform group-hover:rotate-6" />
              Currency
              <span className="absolute bottom-0 left-2 right-2 h-[2px] bg-green-500 rounded-full opacity-0 data-[state=active]:opacity-100 transition" />
            </TabsTrigger>
            ...
            >
              ...
              Language
              <span className="absolute bottom-0 left-2 right-2 h-[2px] bg-blue-500 rounded-full opacity-0 data-[state=active]:opacity-100 transition" />
            </TabsTrigger>
            ...
            <TabsTrigger
              ...
              "
            >
              <Key size={14} className="transition-transform group-hover:rotate-6" />
              API Keys
              <span className="absolute bottom-0 left-2 right-2 h-[2px] bg-yellow-500 rounded-full opacity-0 data-[state=active]:opacity-100 transition" />
            </TabsTrigger>
          </TabsList>
