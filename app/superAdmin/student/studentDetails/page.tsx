...
const StudentDetailsContent = () => {
  ...
  const branchFilter =
    selectedBranch === "all" ? localBranch : (selectedBranchId ?? "all");
  ...
  const fetchStudents = async () => {
    ...
    try {
      ...
      setPage((prev) =>
        prev > (pagination.totalPages || 1) ? pagination.totalPages || 1 : prev,
      );
    } catch (error) {
      toast({
        title: "Error",
  ...
  const fetchBranches = async () => {
    try {
      ...
      // Set default local branch if not selected and global branch does not lock selection
      // Removed auto-selection to keep "All Branch" as default
    } catch (error) {
  ...
  const handleExport = async () => {
    try {
      ...
      const res = await axiosInstance.get("/api/v1/students/export", {
        params,
      ...
      toast({
        title: "Export Failed",
        description: error?.response?.data?.message || "Unable to export data",
        variant: "destructive",
      });
    }
  };
  ...
  }, [searchTerm, classFilter, branchFilter, page, perPage]);
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex items-center justify-between bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 p-5 rounded-2xl shadow-sm border border-border">
          ...
          <div className="flex gap-3">
            ...
            <Button
              onClick={() => router.push("/admin/student/studentAdmission")}
              size="sm"
                ...
                students.map((student: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                        {student?.section?.class?.branch?.name || "-"}
                      </TableCell>
                            ...
                            {selectedStudent && (
                              <div>
                                ...
                                <div className="bg-gradient-to-r from-indigo-600 via-blue-500 to-purple-600 text-white p-6 flex flex-col items-center">
                                  <img
                                    src={
                                      selectedStudent.photo || "/student.png"
                                    }
                                    alt="student"
                                ...
                                <div className="p-6 space-y-6 bg-gray-50 dark:bg-gray-800">
                                  ...
                                  <div className="bg-green-50 dark:bg-green-900/20 p-5 rounded-xl shadow-sm border border-green-200 dark:border-green-800">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
                                      <p>
                                        Admission Fee: ₹
                                        {selectedStudent?.fee?.admissionFee ||
                                          0}
                                      </p>
                                      <p>
                                        Tuition Fee: ₹
                                        {selectedStudent?.fee?.tutionFee || 0}
                                      </p>

                                      <p>
                                        Transport Fee: ₹
                                        {selectedStudent?.fee?.transportFee ||
                                          0}
                                      </p>
                                      <p>
                                        Hostel Fee: ₹
                                        {selectedStudent?.fee?.hostelFee || 0}
                                      </p>

                                      <p>
                                        Other Fee: ₹
                                        {selectedStudent?.fee?.otherFee || 0}
                                      </p>

                                      <p className="font-semibold text-green-800 dark:text-green-400">
                                        Total Fee: ₹
                                        {selectedStudent?.fee?.totalFee || 0}
                                      </p>

                                      <p className="font-semibold text-blue-600 dark:text-blue-400">
                                        Deposited: ₹
                                        {selectedStudent?.fee?.depositFee || 0}
                                      </p>

                                      <p>
                                        Installments:{" "}
                                        {selectedStudent?.fee?.installments ||
                                          1}
                                      </p>
                                  ...
                                  <div className="bg-purple-50 dark:bg-purple-900/20 p-5 rounded-xl shadow-sm border border-purple-200 dark:border-purple-800">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
                                      <p>
                                        <strong>Name:</strong>{" "}
                                        {selectedStudent?.discount?.Discount
                                          ?.name || "-"}
                                      </p>
                                      <p>
                                        <strong>Type:</strong>{" "}
                                      ...
                                      <p className="font-semibold text-purple-700 dark:text-purple-400">
                                        Amount: ₹
                                        {selectedStudent?.discount?.amount || 0}
                                      </p>
                                    </div>
                                  </div>
                              ...
                              <div>
                                ...
                                <div className="p-6 space-y-6 bg-gray-50">
                                  ...
                                  <div className="bg-orange-50 p-5 rounded-xl shadow-sm border">
                                    <h3 className="font-semibold text-orange-700 mb-4">
                                      👨‍👩‍👧 Parent Details
                                    </h3>
                                  ...
                                  <div className="bg-cyan-50 p-5 rounded-xl shadow-sm border">
                                    <h3 className="font-semibold text-cyan-700 mb-4">
                                      🛡 Guardian Details
                                    </h3>
                                  ...
                                  <div className="flex justify-end gap-3 pt-4">
                                    ...
                                    <Button
                                      className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-md hover:shadow-lg rounded-lg"
